            ...
            <CardBody>
              ...
              >
                <Text whiteSpace="pre-line">
                  {
                    "This is a sample post. As it is currently not linked up to any API, the contents of this post, and everything on this page, are hardcoded and unrelated to any of the other pages. To make it longer, here are some random text. \n\n"
                  }{" "}
                  {textContents}
                </Text>
              </Stack>
            ...
            <AccordionItem>
              ...
              <AccordionPanel>
                <Stack mt="10px" divider={<StackDivider />} spacing="4">
                  ...
                  <Comment
                    time="10h ago"
                    comment="Great explanation! Thank you for writing this!"
                    name="Mohammed"
