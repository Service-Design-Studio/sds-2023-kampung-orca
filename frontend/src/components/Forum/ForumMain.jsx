    ...
    >
      ...
      >
        ...
        <Stack direction="column" spacing="10px">  
          <Card padding="20px" shadow='md' width="800px" bg="rgba(255, 255, 255, 0.7)">
          ...
          <Card padding="20px" shadow='md' width="800px" bg="rgba(255, 255, 255, 0.7)" transition="background-color 0.3s ease" _hover={{bg:"#ffbabc"}}>
          ...
          <Card padding="20px" shadow='md' width="800px" bg="rgba(255, 255, 255, 0.7)" transition="background-color 0.3s ease" _hover={{bg:"#ffbabc"}}>
              ...
              <Stack direction="row" align="flex-end">
                ...
                <Text fontSize="sm" fontStyle="italic">by  <span style={{ fontSize:"sm", fontWeight: 'bold' }}>Nessa</span>. Posted 11h ago.</Text>
                </Stack>
                <Text noOfLines={2} pt='2' fontSize='md'>
