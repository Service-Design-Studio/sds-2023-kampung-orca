          ...
          <CardBody>
            <Stack  spacing='4'>
              ...
              <FormControl isRequired>
                ...
                <Input fontSize="22px" value={title} onChange={handleTitleChange} placeholder='Enter title here...' />
              </FormControl>
              <FormControl isRequired>
                <FormLabel>Content</FormLabel>
                <Textarea placeholder='Enter some thoughts here...' value={body} onChange={handleBodyChange} height="300px" resize="none"/>
              </FormControl>
