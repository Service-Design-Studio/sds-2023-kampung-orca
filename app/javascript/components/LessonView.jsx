  ...
  return (
    ...
    <div className="lesson-view-container">
      ...
      <div className="video">
        ...
        <iframe src={placeholderVideoUrl} width="560" height="315" title="Lesson Video" frameBorder="0" allowFullScreen></iframe>
      </div>      
    </div>
  );
