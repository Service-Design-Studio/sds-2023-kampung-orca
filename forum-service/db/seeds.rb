...
Lesson.create([{ title: "Lesson 1", lesson_id: "00001" }, { title: "Lesson 2", lesson_id: "00002" }])
...
Post.create([{ title: "What are the most fun religious festivals?", content: "Give me your top 5. I would like to know about them to be able to hold better interfaith dialogue.", user_id: "3", lesson_id: "00002" }])
Post.create([{ title: "Create some games for people to learn about interfaith.", content: "They can be board games or card games or video games.", user_id: "1", lesson_id: "00002" }])
